let botwRepository = (function () {
  ...
  function addListItem(entry) {
    ...
    entryImage.classList.add("modal-image", "loading");
  ...
  searchValue.addEventListener("keyup", function (e) {
    ...
    itemsToShow.push(
      ...hyruleCompendium.filter(function (item) {
  ...
  function loadCategories() {
    $("#category-dropdown").append(
      `<li class="dropdown-item"><button id="all" onclick="botwRepository.categoryFilter('all')" class="filter-button btn">All Categories</button></li>`
    );
    categories.forEach((category) =>
      $("#category-dropdown").append(
        `<li class="dropdown-item"><button id="${category}" onclick="botwRepository.categoryFilter('${category}')" class="filter-button btn">${
